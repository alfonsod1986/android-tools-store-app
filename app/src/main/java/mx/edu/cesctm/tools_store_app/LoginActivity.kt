...
import mx.edu.cesctm.tools_store_app.api.ApiToolsStoreApp
...
class LoginActivity : AppCompatActivity() {
    ...
    /**
     * Si las credenciales no están vacías, se llama a la ruta para realizar el log in
     * En caso de éxito, se inicia el DashboardActivity
     * En caso de error, se muestra un mensaje que proviene de la respuesta de la API
     */
    private fun attemptLogin(): Unit{
        ...
        if(NetworkUtils.isNetworkAvailable(this@LoginActivity)){
            ...
            if(!mUsername.isEmpty() && !mPassword.isEmpty()){
                ...
                val api: ApiToolsStoreApp = ApiClient.getClient(this@LoginActivity).create(ApiToolsStoreApp::class.java)
